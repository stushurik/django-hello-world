...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.dirname(PROJECT_PATH),'hello.sqlite3'),# Or path to database file if using sqlite3.
...
MIDDLEWARE_CLASSES = (
    ...
    'django_hello_world.hello.middleware.WebRequestMiddleware'
)
