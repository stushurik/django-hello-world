...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelsOperation'
        db.create_table('hello_modelsoperation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 26, 0, 0))),
            ('operation', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('model_class', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal('hello', ['ModelsOperation'])


    def backwards(self, orm):
        # Deleting model 'ModelsOperation'
        db.delete_table('hello_modelsoperation')
    ...
    models = {
        ...
        'hello.modelsoperation': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 26, 0, 0)'})
        },
        'hello.userprofile': {
