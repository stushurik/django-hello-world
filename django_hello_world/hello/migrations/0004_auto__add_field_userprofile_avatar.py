...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hello_userprofile', 'avatar',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('hello_userprofile', 'avatar')
    ...
    models = {
        ...
        'hello.userprofile': {
            ...
            'birthday': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
